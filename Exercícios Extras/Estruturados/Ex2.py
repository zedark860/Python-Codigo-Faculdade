# Dada como entrada uma matriz 2d de caracteres, percorra essa matriz em um padrão de chuva diagonal, contatenadndo os carateres encontrados ao longo da travessia em uma única string;
